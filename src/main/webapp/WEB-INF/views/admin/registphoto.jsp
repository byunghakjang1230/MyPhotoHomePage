...
<head>
    ...
    <link rel="stylesheet" href="/resources/admin/regist/css/main.css" />
    <title>관리자 페이지</title>
</head>
<body>
	<div id="loading">
    ...
    <div id="input_" class="main_box">
        ...
        <div id="input_button_">
            <button type="button" id="img_in">사진 입력</button>
    ...
    <script id="result_tample" type="text/x-handlebars-template">
        ...
        <li>
            <div id="result_field_">
                <div class="img" style="background-image:url('/file/temp?filename={{thumbname}}');">
...
<script src="/resources/admin/regist/js/main.js"></script>
</body>
</html>
