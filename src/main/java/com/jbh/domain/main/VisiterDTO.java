...
public class VisiterDTO {
	...
	public void setError() {
		this.status = this.as = this.city = this.region = this.regionName = this.timezone = this.query = "fail";
		this.lat = this.lon = 0;
		this.country = this.countryCode = "other";
	}
	
	public void setStatusFail() {
		this.as = this.city = this.region = this.regionName = this.timezone = "fail";
		this.country = this.countryCode = "other";
	}
	
	public String toString() {
		return "VisiterDTO [status="+this.status+", country="+this.country+", countryCode="+this.countryCode+
